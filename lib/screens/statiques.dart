...
class Statiques extends StatefulWidget {
  const Statiques({Key? key}) : super(key: key);

  @override
  _StatiquesState createState() => _StatiquesState();
}

class _StatiquesState extends State<Statiques> {
  var hauteur = 150;
  var largeur = 150;
  @override
  Widget build(BuildContext context) {
